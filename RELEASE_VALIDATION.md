...
|---|---:|---:|---:|---:|---:|
| `cpp_clean_v1.rds` | 59,391 | 315 | 59,391 | 59,391 | 11/11 passed |
| `cpp_clean_v3.rds` | 59,391 | 185 | 59,391 | 59,391 | 3/3 passed |
...
It verifies every matched value in the expanded v1 RDS, the three core values
in v3, and both the `v2_` and `v3_` copies in the unified RDS.
